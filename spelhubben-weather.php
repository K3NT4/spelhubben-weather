...
if ( ! function_exists( 'sv_vader_load_plugin_textdomain' ) ) {
	function sv_vader_load_plugin_textdomain() {
		// Bundled Swedish and Norwegian translations must also work when a
		// WordPress.org language pack has not been installed.
...
if ( file_exists( $sv_vader_vc ) ) {
	require_once $sv_vader_vc;
}
