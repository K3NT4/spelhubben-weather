...
/**
 * Translations:
 * Since WordPress 4.6, plugins hosted on WordPress.org should NOT call
 * load_plugin_textdomain() manually. Core will load translations automatically.
 * We keep Text Domain + Domain Path headers for completeness.
 */

// ── PSR-0 style autoloader for SV_Vader_* classes under includes/.
spl_autoload_register(
	function ( $class ) {
		if ( strpos( $class, 'SV_Vader_' ) !== 0 ) {
			return;
		}
...
if ( is_admin() ) {
	$admin = SV_VADER_DIR . 'admin/admin-page.php';
