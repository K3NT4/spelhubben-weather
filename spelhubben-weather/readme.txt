...
Weather widget & block with optional map and daily forecast. Can combine Open-Meteo, SMHI, Yr/MET and FMI data.

== Description ==
This plugin displays current weather and an optional forecast. It can aggregate data from northern-Europe friendly providers (Open-Meteo, SMHI, Yr/MET Norway, and **FMI** / Finnish Meteorological Institute) and compute a simple consensus.
